...
module ADC_DelSig_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("7d1296ae-0b83-4746-9652-d94605d6437e/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("7d1296ae-0b83-4746-9652-d94605d6437e/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
module WaveDAC8_v2_10_2 (
	...
	cy_clock_v1_0
		#(.id("002dc70c-c77f-4ba5-b7f8-ea3a44ef7a48/77086516-855e-4b7b-abbe-47b22f8543de"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("232d9fdb-cdb9-42d2-ba0a-008e3157680a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ebf1c1e7-806e-4db9-9ccb-de64818aa5dc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9cc73de8-0b04-4ffd-af06-cd13565ce739"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6d123c60-f668-4eaf-9aab-828b4cab4207"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
